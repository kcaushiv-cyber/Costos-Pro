...
<a href="http://localhost:5001" class="btn">Ir al sistema →</a>
""")
        mail.send(msg)
        return True
...
<a href="http://localhost:5001/kardex" class="btn">Ver Kardex →</a>
""")
        mail.send(msg)
...
<a href="http://localhost:5001/login" class="btn">Ingresar al sistema →</a>
